export default async function handler(req,res){
  ...
  try{
    ...
    if(action==='start'){
      ...
      const p={type:'screen-share',state:'sharing',deviceId:device,peerId:String(b.peer_id||''),host:String(b.username||'User').slice(0,40),quality,fps,frozen:false,startedAt:now,updatedAt:now};
